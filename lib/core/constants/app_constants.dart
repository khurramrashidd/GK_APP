class AppConstants {
  ...
  /// Numeric build number, compared against the value an admin publishes to
  /// decide whether an update is available.
  ///
  /// A plain integer rather than parsing "1.2.3" strings: version-string
  /// comparison has real edge cases ("1.10" vs "1.9", trailing suffixes like
  /// "-beta") and a monotonically increasing int has none. BUMP THIS every
  /// time you build an APK you intend to distribute.
  ...
  /// is lower than this.
  // Bumped to 3: added clause 2.6 (ongoing review) and 2.7 (no exam
  // guarantee). Raising this re-prompts every user to accept the new terms.
  static const int termsVersion = 3;
