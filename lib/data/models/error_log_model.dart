...
class ErrorLogModel {
  ...
  /// Marked true once an admin has dealt with it. Resolved logs drop out of
  /// the default list but aren't deleted, so a fix can be reviewed later.
  final bool resolved;
  ...
  factory ErrorLogModel.fromMap(String id, Map<String, dynamic> m) =>
      ErrorLogModel(
        ...
        resolved: (m['resolved'] ?? false) as bool,
