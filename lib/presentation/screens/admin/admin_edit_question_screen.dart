    ...
    return Scaffold(
      ...
      body: _loading
          ...
          : _error != null
              ...
              // A question can finish loading with no error AND no result —
              // e.g. it was deleted, or the id is stale. Without this branch
              // the _q! below throws "Null check operator used on a null
              // value", which is exactly what the crash logs showed.
              : _q == null
                  ? const Padding(
                      padding: EdgeInsets.all(24),
                      child: Center(
                          child: Text(
                              'This question no longer exists. It may have '
                              'been deleted.')),
                    )
