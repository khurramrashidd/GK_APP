  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          RefreshAction(onRefresh: () async => ref.invalidate(historyProvider)),
        ],
      ),
                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: CircleAvatar(
                      backgroundColor: _accColor(r.accuracy).withValues(alpha: 0.15),
                      child: Text('$acc%',
                          style: TextStyle(
                              fontSize: 12,
                    ...
                    subtitle: Text(
                      // Domain first so you can tell at a glance WHAT the
                      // quiz covered, not just the score.
                      '${r.domainName}\n'
