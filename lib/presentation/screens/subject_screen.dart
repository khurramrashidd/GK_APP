...
class _SubjectScreenState extends ConsumerState<SubjectScreen> {
                ...
                : subjects.isEmpty
                    ...
                    : GridView.builder(
                        ...
                        itemBuilder: (context, i) =>
                            _subjectCard(theme, subjects[i], i + 1),
                      ),
          ),
        ],
      ),
  ...
  Widget _subjectCard(ThemeData theme, SubjectModel s, int serial) {
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () {
          // A subject with an admin-written summary gets an intro screen
          // first; everything else goes straight to the quiz as before.
          final hasIntro = (s.description ?? '').trim().isNotEmpty;
          Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => hasIntro
                ? SubjectIntroScreen(domain: widget.domain, subject: s)
                : routesToSubLevels
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  // Serial number badge — makes a long subject list easy to
                  // scan, count and refer to.
                  Container(
