...
class QuestionRepository {
  ...
  Future<List<QuestionModel>> getSubjectQuestionsOnDemand(
    ...
    try {
      ...
      //
      // `await` matters here: returning the future unawaited lets it escape
      // this try block, so a cache read failure would NOT fall through to
      // the offline fallback below.
      return await _local.getQuestions(domainId, subjectId,
          subLevelId: subLevelId);
    } catch (_) {
